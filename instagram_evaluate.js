...
class instagram_evaluater {
	evaluate(posts) {
		...
		return ([grade.network.activate([parseFloat(mean_user_engagement_rate), parseFloat(interaction_rate), parseFloat(comments_disabled_rate), parseFloat(within_range/posts_timeline.length)])[0], is_beauty, is_family]);
	}
